...
module RuPropisju
  ...
  TRANSLATIONS = {
    'en' => {
      0 => "",
      '0' => "zero",
      :thousands => ["thousand", "thousands", "thousands"],
      :millions => ["million", "millions", "millions"],
      :billions => ["billion", "billions", "billions"],
      100 => "one hundred",
      200 => "two hundred",
      300 => "three hundred",
      400 => "four hundred",
      ...
      8 => "eight",
      9 => "nine",
      :rub_integral => ["ruble", "rubles", "rubles"],
      :rub_fraction => ['copeck', 'copecks', 'copecks'],
      ...
      :eur_integral => ["euro", "euro", "euro"],
      # по опыту моей прошлой работы в банке
      # центами называют дробную часть доллара
      # а дробную часть евро называют евроцентом
      :eur_fraction => ["eurocent", "eurocents", "eurocents"],
      :usd_integral => ["dollar", "dollars", "dollars"],
      :usd_fraction => ['cent', 'cents', 'cents'],
    },
    'ru' => {
      0 => "",
      '0' => "ноль",
