...
class TestRuPropisju < Test::Unit::TestCase
  ...
  def test_rublej
    ...
    assert_equal "ноль рублей 42 копейки", RuPropisju.rublej(0.4187)
  ...
  def test_griven
    ...
    assert_equal "ноль гривен сорок две копейки", RuPropisju.griven(0.4187)
  ...
  def test_tenge
    ...
    assert_equal "ноль тенге сорок два тиына", RuPropisju.tenge(0.4187)
  ...
  def test_kopeek
    ...
    assert_equal "ноль рублей 32 копейки", RuPropisju.kopeek(32)
    assert_equal "ноль рублей 21 копейка", RuPropisju.kopeika(21)
    assert_equal "ноль рублей 3 копейки", RuPropisju.kopeiki(3)
  ...
  def test_options
    ...
    assert_equal "ноль рублей 42 копейки", RuPropisju.rublej(0.4187, :ru, options)
    ...
    assert_equal "ноль рублей 42 копейки", RuPropisju.rublej(0.4187, :ru, options_custom_formatter)
